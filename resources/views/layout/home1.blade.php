<html>
    ...
    <body>
      <div class="slideshow">
        @if($films !=null)
          @foreach ($films as $filme)
          @if($filme->num==0 || $filme->num==1)
          <div class="mySlides fadee">
          <a href="../datials/{{$filme->id}}"> <img src="../image/{{$filme->film_img}}" style="width:100%;height:670px"></a>
          </div>
          @else
          <div class="mySlides fadee">
          <a href="../chain/{{$filme->id}}"> <img src="../image/{{$filme->film_img}}" style="width:100%;height:670px"></a>
          </div>
          @endif
          @endforeach
        @endif
          ...
          <nav class="navbar navbar-default navbar-fixed-top">
           <div class="container-flauid">
            ...
            <div class="col-md-7 col-sm-7 col-xs-7 text-center logo wow bounceInUp data-wow-duration="2s"">
              <h1>Ratatouille</h1>
            </div>
            <div class="film">
              <div class="container">
